...
class FlowerClient(NumPyClient):
    ...
    def __init__(self, model_config: ModelConfig, client_type: str, client_state: RecordSet, train_loader, val_loader):
    ...
    def evaluate(self, parameters: NDArrays, config: dict[str, Scalar]) -> tuple[float, int, dict[str, Scalar]]:
        ...
        """
        set_weights(self.model, parameters)
        loss, accuracy = test(self.model, self.val_loader, self.device, self.model_config)
